...
public class FileName implements Comparable<FileName>{
	...
	/**
	 * Creates a new file name with given path.
	 * Path separator will be {@link File#separator}.
	 ...
	 * @param path The path to the file or the system property key
	 * @param separator Path separator of given path
	 */
	 ...
	 * Path separator will be {@link File#separator}.
	 * @param path The path to the file or the system property key
	 * @param sysProp Boolean whether path should be system property key
	 */
	public FileName(String path, boolean sysProp){
		this(path, sysProp, "");
	}
	/**
	 * Creates a new file name with given path that can be a system property key and the given path separator.
	 * @param path The path to the file or the system property key
	 * @param systemProp Boolean whether path should be system property key
	 * @param separator Path separator of given path
	 */
	public FileName(String path, boolean systemProp, String separator){
		
		//Set up separator
		separator = systemProp || separator.equals("") ? File.separator : separator;
		
		//Create path string
		path = systemProp ? System.getProperty(path) : path.replaceAll(separator + "$", "");
	...
	/**
	 * Creates a file with the given path with {@link File#separator} as path separator
	...
	/**
	 * Returns the path to the file with {@link Path#getSeparator()} as path separator.
